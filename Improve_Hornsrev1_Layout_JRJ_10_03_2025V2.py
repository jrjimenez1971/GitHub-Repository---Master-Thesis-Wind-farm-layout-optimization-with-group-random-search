...
global solutions_dic_var_iter_lenght_x
global bestfitness_dic_var_iter_lenght_x
global aep_best_sol_iter_length_x
global gensolutions_dic_var_iter_lenght_x
global genbestfitness_dic_var_iter_lenght_x
...
def getSolutions():
    solutions_dic_var_iter_lenght_x = {"0":[],"1":[], "2":[]}
    bestfitness_dic_var_iter_lenght_x = {"0":[],"1":[], "2":[]}
    ...
    for x in iter_lengths:
        ...
        bestfitness_dic_var_iter_lenght_x[x] = bestsolution[0]
        bestsolution = ( (bestsolution[1][0],bestsolution[1][1]) )
        solutions_dic_var_iter_lenght_x[x] = bestsolution  
        aep_best_sol_iter_length_x[x] = float(windFarmModel(bestsolution[0],bestsolution[1]).aep().sum())
    best_lenght = max(bestfitness_dic_var_iter_lenght_x, key=bestfitness_dic_var_iter_lenght_x.get)
    bestsolution = solutions_dic_var_iter_lenght_x[best_lenght] 
    ...
    return bestsolution, aep_best_sol,solutions_dic_var_iter_lenght_x,aep_best_sol_iter_length_x
    
def getGenSolutions(imputsolution,aep_best_sol_prev):
    gensolutions_dic_var_iter_lenght_x = {"0":[],"1":[], "2":[]}
    genbestfitness_dic_var_iter_lenght_x = {"0":[],"1":[], "2":[]}
    ...
    for i in range(1,Gen_Num+1):
        ...
        for x in iter_lengths.values:
            ...
            gensolutions_dic_var_iter_lenght_x[x] = genbestsolution
            aep_best_gensol_iter_length_x[x] = float(windFarmModel(genbestsolution[0],genbestsolution[1]).aep().sum())
            genbestfitness_dic_var_iter_lenght_x[x] = genbestsolution
            Gen_Iter_Lenght_Pack_x.append((aep_best_gensol_iter_length_x,genbestfitness_dic_var_iter_lenght_x))
        best_lenght = max(genbestfitness_dic_var_iter_lenght_x, key=genbestfitness_dic_var_iter_lenght_x.get)
        genbestsolution = gensolutions_dic_var_iter_lenght_x[best_lenght]          
    ...
    return genbestsolution, Gen, NewGen_i_best, aep_best_gensol_i,aep_best_gensol_calc_i,genbestfitness_dic_var_iter_lenght_x,Gen_Iter_Lenght_Pack_x,Gen_Generations_Pack_i
...
solutions_dic_var_iter_lenght_i = sol[2]
aep_best_sol_iter_length_i =sol[3]
...
Gen_Iter_Lenght_Pack_x = SolGen[6]
Gen_Generations_Pack_i = SolGen[7]
