...
# Offset#1:
row_offset_x_1 = np.linspace(0,1,8)* (+1.1*scale)
row_offset_y_1 = np.linspace(0,1,8) * (-1.1*scale)
col_offset_x_1 = np.linspace(0,1,10) * (+1.1*scale)
col_offset_y_1 = np.linspace(0,1,10) * (-1.1*scale)
