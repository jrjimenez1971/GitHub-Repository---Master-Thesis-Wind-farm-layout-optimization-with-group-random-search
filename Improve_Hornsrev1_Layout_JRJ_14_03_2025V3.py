...
def crear_dataframe_con_arrays(arrays, nombres_columnas):
    """
    Crea un DataFrame de Pandas con columnas cargadas de arrays proporcionados.
    Args:
        arrays (list): Una lista de arrays, donde cada array representa una columna.
        nombres_columnas (list): Una lista de nombres para las columnas.
    Returns:
