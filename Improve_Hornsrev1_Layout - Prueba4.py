...
# aep_prueba = windFarmModel(solutions[0][0],solutions[0][1]).aep().sum()
# aep_prueba = float(aep_prueba)
# print("aep_prueba:", aep_prueba)
...
for i in range(10):
    ...
    # print(rankedsolutions[0:10])

    if rankedsolutions[0][0] > 600:
        break
    
    aep_prueba = windFarmModel(solutions[0][0],solutions[0][1]).aep().sum()
    aep_prueba = float(aep_prueba)
    print("aep_prueba:", aep_prueba)
    print("otim_func:", optim_func)
...
x_max,y_max = (bestsolutions[1][0],bestsolutions[1][1])
print(x_max,y_max)
aep_max = windFarmModel(x_max,y_max).aep().sum()
