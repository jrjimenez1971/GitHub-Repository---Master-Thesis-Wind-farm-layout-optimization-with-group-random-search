...
numero_aleatorio_rox = (rnd.random()*2)-1
numero_aleatorio_roy = (rnd.random()*2)-1
numero_aleatorio_cox = (rnd.random()*2)-1
numero_aleatorio_coy = (rnd.random()*2)-1

row_offset_x = np.linspace(0,1,8)* 500 * numero_aleatorio_rox
row_offset_y = np.linspace(0,1,8) * 500 * numero_aleatorio_roy
col_offset_x = np.linspace(0,1,10) * 500 * numero_aleatorio_cox
col_offset_y = np.linspace(0,1,10) * 500 * numero_aleatorio_coy
